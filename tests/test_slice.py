...
def test_slicepy_identity_defaults_to_input_xy_shape():
    slicepy = _load_slicepy()
...
def test_slicepy_custom_shape_uses_min_value_for_clamp_and_out_of_bounds():
    slicepy = _load_slicepy()
